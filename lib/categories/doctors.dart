  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Container(
        ...
        context,
        MaterialPageRoute(
          builder: (contex) => doc_page(namedoc,spec,place,numb1,numb2,img),
        )),
          child: Padding(
                  ...
                  children: [
                    Container(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(namedoc,style: TextStyle(color: write,fontWeight: FontWeight.bold,fontSize: 23),),
                        Text(place,style: TextStyle(color: write,fontWeight: FontWeight.w400,),),
                      ],
                    )),
                    Row(
                      children: [
